...
function getDatapelanggan() {
    axios.get("http://localhost/javascript/tugasDummyJSON2/php/get.php").then(function (response) {
...
function addDatapelanggan() {
    ...
    axios.post("http://localhost/javascript/tugasDummyJSON2/php/add.php", JSON.stringify(data)).then(function (response) {
        alert(response.data);
        getDatapelanggan();
    })
}
...
function showUpdatepelanggan(idpelanggan) {
    ...
    axios.post("http://localhost/javascript/tugasDummyJSON2/php/selectupdate.php", JSON.stringify(data)).then(function (response) {
...
function updateDatapelanggan() {
    ...
    axios.post("http://localhost/javascript/tugasDummyJSON2/php/update.php", JSON.stringify(datapelanggan)).then(function (response) {
        alert(response.data);
        getDatapelanggan();
    })
}
...
function deleteDatapelanggan(idpelanggan) {
    ...
    axios.post("http://localhost/javascript/tugasDummyJSON2/php/delete.php", JSON.stringify(data)).then(function (response) {
        alert(response.data);
        getDatapelanggan();
    })
}
...
function cartPelanggan(idpelanggan) {
    axios.get("http://localhost/javascript/tugasDummyJSON2/php/selectwhere.php/?id=" + idpelanggan).then(function (response) {
        // console.log(response);
...
function finalCheckout(idproduct, price, product) {
    ...
    axios.post("http://localhost/javascript/tugasDummyJSON2/php/addtocart.php", JSON.stringify(data)).then(function (response) {
        // console.log(response);
        alert(response.data);
    })
}