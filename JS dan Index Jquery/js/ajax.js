...
function getDatapelanggan() {
    $.ajax({
        type: "get",
        url: "http://localhost/javascript/tugasDummyJSON2/php/get.php",
        cache: false,
        dataType: "json",
        success: function (response) {
            let out = `<thead><tr>
...
function cartPelanggan(id) {
    ...
    $.ajax({
        type: "get",
        url: "http://localhost/javascript/tugasDummyJSON2/php/selectwhere.php?id=" + id,
        data: "contentType",
        dataType: "json",
        success: function (response) {
...
function addDatapelanggan() {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/javascript/tugasDummyJSON2/php/add.php",
        cache: false,
...
function selectUpdatepelanggan(id) {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/javascript/tugasDummyJSON2/php/selectupdate.php",
        cache: false,
...
function updateDatapelanggan(id) {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/javascript/tugasDummyJSON2/php/update.php",
        cache: false,
...
function deleteDatapelanggan(id) {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/javascript/tugasDummyJSON2/php/delete.php",
        cache: false,
        data: JSON.stringify(idpelanggan),
        // dataType: "dataType",
        success: function (response) {
...
function checkOut() {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/javascript/tugasDummyJSON2/php/addtocart.php",
        data: JSON.stringify(data),
        success: function (response) {
            alert(response);
        }
